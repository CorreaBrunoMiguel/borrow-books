...
- [ ] Subir `.gitignore`
- [ ] Planejar Sprint 1 (objetivo, escopo, critérios)
...
- [ ] Endpoints CRUD (users, books) + criação/listagem de loans
- [ ] Regra: impedir empréstimo sem cópias disponíveis
- [ ] Client: bootstrap do React + login mínimo
